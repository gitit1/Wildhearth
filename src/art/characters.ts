import { shadow, roundR } from "./shapes";
...
export function drawFarmer(g: CanvasRenderingContext2D, p: Player, t: number) {
  ...
  g.fillStyle = "#b0432f"; roundR(g, -8, -10, 16, 15, 5); g.fill();
  ...
  g.fillStyle = "#e8b48a"; g.beginPath(); g.arc(0, -16, 7, 0, 7); g.fill();
  g.fillStyle = "#2a2a30";
  ...
  g.fillStyle = "#e0be5c";
  g.beginPath(); g.ellipse(0, -20, 11, 4, 0, 0, 7); g.fill();
  g.beginPath(); g.ellipse(0, -23, 6.5, 4.5, 0, 0, 7); g.fill();
...
export function drawCow(g: CanvasRenderingContext2D, c: Cow, t: number) {
  ...
  g.fillStyle = "#f2efe8"; roundR(g, -18, -10, 36, 18, 9); g.fill();
  g.fillStyle = "#3a3a40";
  g.beginPath(); g.ellipse(-6, -4, 7, 5, 0.4, 0, 7); g.fill();
  g.beginPath(); g.ellipse(9, 2, 5, 4, -0.4, 0, 7); g.fill();
  g.fillStyle = "#f2efe8"; roundR(g, 14, -14, 14, 12, 6); g.fill();
...
export function drawHen(g: CanvasRenderingContext2D, h: Hen, t: number) {
  ...
  g.fillStyle = "#f5f2ea"; g.beginPath(); g.ellipse(0, 0, 7, 6, 0, 0, 7); g.fill();
  g.beginPath(); g.arc(5, -4 + peck, 4, 0, 7); g.fill();
