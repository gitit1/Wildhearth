import { SAVE_KEY, SKILLS_KEY, RENOVATION_KEY, META_KEY, CALENDAR_KEY, WEATHER_KEY, WORLD_FLAGS_KEY, LIVESTOCK_KEY, PLOTS_KEY, GARDEN_KEY, COLLECTIONS_KEY, MEMORIES_KEY, NEEDS_KEY, RELATIONSHIPS_KEY, SLOT_KEY, GUIDANCE_KEY, QUESTS_KEY, STORAGE_KEY, CUSTOMERS_KEY, REPUTATION_KEY, DISCOVERY_KEY, TRANSPORT_KEY, TEACHING_KEY, AI_ANTIREP_KEY, AI_BACKSTORY_KEY, AI_ARCS_KEY, AI_DEVNOTES_KEY } from "../config";
...
const GAME_KEYS = [SAVE_KEY, SKILLS_KEY, RENOVATION_KEY, META_KEY, CALENDAR_KEY, WEATHER_KEY, WORLD_FLAGS_KEY, LIVESTOCK_KEY, PLOTS_KEY, GARDEN_KEY, COLLECTIONS_KEY, MEMORIES_KEY, NEEDS_KEY, RELATIONSHIPS_KEY, SLOT_KEY, GUIDANCE_KEY, QUESTS_KEY, STORAGE_KEY, CUSTOMERS_KEY, REPUTATION_KEY, DISCOVERY_KEY, TRANSPORT_KEY, TEACHING_KEY, AI_ANTIREP_KEY, AI_BACKSTORY_KEY, AI_ARCS_KEY, AI_DEVNOTES_KEY];
